...
class SentimentAnalyzer:
    ...
    def __init__(self, model_id, dataset_name, seed=42, output_dir="./checkpoints/sentiment-analysis/13b-lora"):
    ...
    def load_data(self):
        ...
        imdb = load_dataset(self.dataset_name)
        raw_dataset = imdb["train"].shuffle(seed=self.seed).select([i for i in list(range(3000))])
